...
deaths <- av %>%
  pivot_longer(cols = starts_with("Death"), 
               names_to = "Time", 
               values_to = "Death") %>%
  mutate(Time = parse_number(Time))  # Extract the numeric part of the column name
head(deaths)
...
# Filter for Avengers who have died at least once
avengers_died <- deaths %>%
  filter(Death == "YES") %>%            # Only rows where Death is "YES"
  distinct(Name.Alias)                   # Get unique Avengers who died

# Count of Avengers who died at least once
